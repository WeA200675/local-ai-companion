...
OPEN_SOURCE_MODEL_CATALOG: tuple[CatalogModel, ...] = (
    ...
    CatalogModel("mistral:7b-instruct", "Mistral 7B Instruct", "Mistral", "7B", "Apache-2.0", "kompakter Instruktions-/Dialog-Allrounder", "https://ollama.com/library/mistral:7b-instruct"),
    ...
    CatalogModel("mixtral:8x7b", "Mixtral 8x7B", "Mixtral", "8x7B MoE", "Apache-2.0", "mehrsprachiger MoE-Allrounder mit gutem Deutsch", "https://ollama.com/library/mixtral"),
    CatalogModel("mixtral:8x22b", "Mixtral 8x22B", "Mixtral", "8x22B MoE", "Apache-2.0", "großes mehrsprachiges MoE-Modell", "https://ollama.com/library/mixtral"),
    CatalogModel("dolphin-mistral:7b", "Dolphin Mistral 7B", "Dolphin/Mistral", "7B", "Apache-2.0", "steuerbarer Companion-/Coding-Finetune", "https://ollama.com/library/dolphin-mistral", uncensored=True, note="Ollama bezeichnet diese Modellfamilie ausdrücklich als uncensored und veröffentlicht Apache-2.0-Lizenzmetadaten."),
    CatalogModel("dolphin-mixtral:8x7b", "Dolphin Mixtral 8x7B", "Dolphin/Mixtral", "8x7B MoE", "Apache-2.0", "steuerbarer MoE-Companion-/Coding-Finetune", "https://ollama.com/library/dolphin-mixtral", uncensored=True, note="Ollama bezeichnet 8x7B und 8x22B ausdrücklich als uncensored; die Modellmetadaten weisen Apache-2.0 aus."),
    CatalogModel("dolphin-mixtral:8x22b", "Dolphin Mixtral 8x22B", "Dolphin/Mixtral", "8x22B MoE", "Apache-2.0", "großer steuerbarer MoE-Companion-/Coding-Finetune", "https://ollama.com/library/dolphin-mixtral", uncensored=True, note="Ollama bezeichnet 8x7B und 8x22B ausdrücklich als uncensored; die Modellmetadaten weisen Apache-2.0 aus."),
